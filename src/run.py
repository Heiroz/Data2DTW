...
timeseries_raw.process(raw_flow_folder, raw_timeseries_folder, '2000ms', 50000, 10)
timeseries_syn.process(syn_flow_folder, syn_timeseries_folder, '2000ms', 50000, 10)
