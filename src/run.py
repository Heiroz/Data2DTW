...
# timeseries_raw.process(raw_flow_folder, raw_timeseries_folder, '200ms', 50000, 100)
# timeseries_syn.process(syn_flow_folder, syn_timeseries_folder, '200ms', 50000, 100)
